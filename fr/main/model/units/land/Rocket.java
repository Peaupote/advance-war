...
public class Rocket extends Unit implements LandVehicleUnit,DistanceUnit {

	public Rocket(Player player, Point point){
		super(player, point, 99, MoveType.Wheel, 6, 2, null, null);
	}

	public Rocket(Player player, int x, int y){
