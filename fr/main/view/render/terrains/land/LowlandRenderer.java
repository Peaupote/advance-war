...
public class LowlandRenderer extends Lowland implements Renderer {
	...
	private transient static HashMap<TerrainLocation.LowlandLocation, LowlandRenderer> instances;

	private LowlandRenderer(TerrainLocation.LowlandLocation location) {
	...
	public static LowlandRenderer get(TerrainLocation.LowlandLocation loc) {
		if (instances == null) instances = new HashMap<>();
